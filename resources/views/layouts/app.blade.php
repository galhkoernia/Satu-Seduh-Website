...
<head>
    ...
    <link ref="stylesheet" href="{{ asset('assets/css/style.css') }}">
...
<body class="bg-white text-[#3c2f2f]">
    ...
    <!-- Navbar -->
    <nav class="bg-[#d2b48c] px-4 py-3 flex justify-between items-center">
        <a href="{{ url('/') }}" class="text-xl font-playfair">Satu Seduh</a>
        <ul class="flex gap-4 text-sm">
            <li><a href="{{ url('/') }}" class="hover:text-white">Home</a></li>
            <li><a href="{{ url('/product') }}" class="hover:text-white">Product</a></li>
            <li><a href="{{ url('/about') }}" class="hover:text-white">About</a></li>
            <li><a href="{{ url('/event') }}" class="hover:text-white">Event</a></li>
        </ul>
    </nav>
